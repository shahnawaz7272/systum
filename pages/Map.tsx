  ...
  return (
   <section> 
    <div className="ludo-map-container flex justify-center items-center pt-[60px] ">
        <div className="map">
           <div className="upper-map ls:h-[240px] ls:w-[600px] md:w-[450px] md:h-[180px] mp:w-[150px] mp:h-[60px] flex"> 
            <Home color="red"/>
            <Path ori="vertical" color="green"/>
            <Home color="green"/>
            </div>
            <div className="middle-map ls:h-[120px] ls:w-[600px] md:w-[450px] md:h-[90px] mp:w-[150px] mp:h-[30px] flex ">
            <Path ori="horizontal" color="red"/>
            <Safezone/>
            <Path ori="horizontal" color="yellow"/>
            </div>
            <div className="lower-map ls:h-[240px] ls:w-[600px] md:w-[450px] md:h-[180px] mp:w-[150px] mp:h-[60px] flex"> 
            <Home color="blue"/>
